...
overall_plot <- gender_count %>% 
  ...
  scale_x_sqrt(breaks = c(2000, 6000, 10000)) +
  ...
  theme(legend.position = 'None',
        plot.margin = margin(15, 7.5, 5.5, 5.5),
...
gender_race <- plot_grid(age_severity, race_plot, ncol = 1,
          rel_heights = c(1.7, 1), labels = c('C', 'D'), axis = 'r')
abcd <- plot_grid(overall_plot, age_plot, gender_race, ncol = 3,
                  rel_widths = c(1, 1, 1.25), labels = c('A', 'B', ''),
                  axis = 'b')
abcd
ggsave('figs/composite_plot.png', abcd, height = 6, width = 10)
```
