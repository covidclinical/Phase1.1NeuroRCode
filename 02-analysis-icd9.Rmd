...
ggsave('figs/icd9_diff_heatmap.png', diff_heat, height = 5.5, width = 7)
```

```{r}
na_check <- diag_icd_9 %>% 
  group_by(icd, time, siteid) %>% 
  filter(n()>1)
```
...
ggsave('figs/icd9_prevalence.png', icd_prevalence_plots, height = 5, width = 10)
```
