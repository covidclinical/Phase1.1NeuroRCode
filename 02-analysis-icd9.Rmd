...
plot_grid(diff_heat, icd9_prevalence_plots, rel_heights = c(1, 0.85),
          ncol = 1, labels = 'AUTO') %>%
  ggsave('figs/tiffs/icd9_prevalence_AB.tiff', ., height = 8, width = 9.7, dpi = 300)
```
...
ggsave('figs/tiffs/icd9_heatmap.tiff', heats, height = 10, width = 7, dpi = 300)
```
...
ggsave('figs/tiffs/icd9_severe_heatmap.tiff', severe_heats, height = 10, width = 7, dpi = 300)
```
...
ggsave('figs/tiffs/icd9_severe_before_after.tiff', enrichment_plot, width = 9.5, height = 7, dpi = 300)
```
...
ggsave('figs/tiffs/icd9_severe.png', plot_enrich_both, width = 9, height = 5, dpi = 300)
```
