...
plot_grid(diff_heat, icd9_prevalence_plots, rel_heights = c(1, 0.85),
          ncol = 1, labels = 'AUTO') %>%
  ggsave('figs/tiffs/efig_3.tiff', ., height = 8, width = 9.7, dpi = 300)
```
...
ggsave('figs/tiffs/efig_2.tiff', heats, height = 10, width = 7, dpi = 300)
```
...
enrichment_plot
ggsave('figs/icd9_severe_before_after.png', enrichment_plot_after, width = 9.5, height = 3.5)
ggsave('figs/tiffs/efig_4.tiff', enrichment_plot_after, width = 9.5, height = 3.5, dpi = 300)
```
